  ...
  return (
    <div className='border-t-2 border-b-2 bg-indigo-400 mt-12 p-8'>
      <div className='grid grid-cols-12 container'>
        <div className='col-span-12 md:col-span-8 flex flex-col place-self-center'>
          <h2 className='font-semibold text-4xl mb-5'>Stay in the know</h2>
        ...
        <div className='col-span-4  rounded-full border-2 w-[100px]  h-[100px] md:w-[300px] md:h-[300px] relative self-center hidden md:block'>
          <Image
            src='/coffee.png'
            width={300}
            height={300}
